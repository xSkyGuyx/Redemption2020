...
import frc.robot.commands.AutoCommands.DriveOffLinePath;
...
public class RobotContainer {
  ...
  public final static DefaultDriveCommand defaultDrive = new DefaultDriveCommand();
  public final static IntakeStop intakeStop = new IntakeStop();
  ...
  public RobotContainer() {
    ...
    m_auto_chooser.setDefaultOption("Drive Off Line", new DriveOffLinePath());
